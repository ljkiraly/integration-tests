...
func (s *Suite) SetupSuite() {
	...
	r := s.Runner("../nsm-deployments-k8s/examples/k8s_monolith/spire")
	s.T().Cleanup(func() {
		r.Run(`kubectl delete crd spiffeids.spiffeid.spiffe.io` + "\n" + `kubectl delete ns spire`)
	})
	r.Run(`kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/k8s_monolith/spire?ref=97ac28963a8e86054ced1884a04e241d53dfcdd4`)
